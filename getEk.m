...
[gradientVec, gradientTangent, normalizedNormVec, triangleCenter, A_t] = compute_gradientGPU(v, f, scalar');
%normGradientVec = gradientVec./vecnorm(gradientVec,2,2);
normGradientTangent = gradientTangent./sqrt(sum(gradientTangent.^2, 1));
normGradientVec = gradientVec./sqrt(sum(gradientVec.^2, 1));
